...
***
### crnn模型效果(实验中)
使用 MJSynth(MJ) 和 SynthText(ST) 训练，以batchsize=512迭代了120000次，在以下数据集上测试：
| 模型      |  CUTE80 |   IC03_867 |IC13_1015|IC13_857|IC15_1811|IC15_2077|IIIT5k_3000|SVT|SVTP|mean|
| :-------- | --------:| :------: |--------:| :------: |--------:| :------: |
| resnet34+lstm+ctc |  82.98|  91.92|90.93|91.59|73.10|67.98|90.16|85.16|78.29|83.56|
