...
def resnet18(pretrained=True, load_url=True,**kwargs):
...
def deformable_resnet18(pretrained=True,load_url=True, **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
...
def resnet50(pretrained=True,load_url=True,**kwargs):
...
def deformable_resnet50(pretrained=True,load_url=True, **kwargs):
