...
def prune(args):
    ...
    torch.save(new_model.state_dict(), os.path.join(args.save_prune_model_path, 'pruned_dict.pth.tar'))
    

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Hyperparams')
    parser.add_argument('--base_num', nargs='?', type=int, default = 4,
    ...
    parser.add_argument('--config', default='./config/det_DB_mobilev3.yaml',
                        ...
                        help='config path')
    parser.add_argument('--checkpoint', default='./checkpoint/ag_DB_bb_mobilenet_v3_small_he_DB_Head_bs_16_ep_1200/DB_best.pth.tar',
                        type=str, metavar='PATH',
                        help='ori model path')
    parser.add_argument('--save_prune_model_path', default='./checkpoint/ag_DB_bb_mobilenet_v3_small_he_DB_Head_bs_16_ep_1200/pruned/', type=str, metavar='PATH',
